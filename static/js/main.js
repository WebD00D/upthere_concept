document.addEventListener("DOMContentLoaded", function() {
  ...
  //  console.log("SCROLL: ", currentScrollPosition, "section b top", offset(document.getElementsByClassName("js_section_one_b")[0]).top)
    ...
    if ( currentScrollPosition >= offset(document.getElementsByClassName("js_section_one_b")[0]).top ) {
      sectionOneB.classList.remove("section--relative");
      sectionOneB.classList.add("section--fixed");
    }

    if ( sectionOneB.classList.contains("section--fixed") && currentScrollPosition <= 800 ) {
    ...
    if ( offset(section_two_a_100p).top <= offset(sectionTwoB).top && offset(section_two_a_100p).top >= offset(sectionTwoB).top - 200 ) {
      console.log("show the first phone slide");
    }
    if ( offset(section_two_a_75p).top <= offset(sectionTwoB).top && offset(section_two_a_75p).top >= offset(sectionTwoB).top - 200 ) {
      console.log("show the second phone slide");
    }
    if ( offset(section_two_a_50p).top <= offset(sectionTwoB).top && offset(section_two_a_50p).top >= offset(sectionTwoB).top - 200 ) {
      console.log("show the third phone slide");
    }
    if ( offset(section_two_a_25p).top <= offset(sectionTwoB).top && offset(section_two_a_25p).top >= offset(sectionTwoB).top - 200 ) {
