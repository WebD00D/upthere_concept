document.addEventListener('DOMContentLoaded', function() {
	...
	document.getElementById('js_play-video').onclick = function(e) {
		e.preventDefault();
		document.getElementsByClassName('video-modal')[0].classList.remove('video-modal--hidden');
	...
	document.getElementsByClassName('video-modal')[0].onclick = function() {
		document.getElementsByClassName('video-modal')[0].classList.add('video-modal--hidden');
	...
	document.getElementsByClassName('js-phone-container')[0].setAttribute('data-phone-last-animated', initTime);
	...
	function handleScroll(e) {
		...
		const sectionOneContainer = document.getElementsByClassName('js_section_one_container')[0];
		...
		if (currentScrollPosition >= offset(document.getElementsByClassName('js_section_one_b')[0]).top + 200) {
		...
		if (sectionOneB.classList.contains('section--fixed-b') && currentScrollPosition <= 1070) {
		...
		const sectionTwoContainer = document.getElementsByClassName('js_section_two_container')[0];
		...
		const section_one_b_25p = document.getElementsByClassName('js_section_one_b_25p')[0];
		const section_one_b_50p = document.getElementsByClassName('js_section_one_b_50p')[0];
		const section_one_b_75p = document.getElementsByClassName('js_section_one_b_75p')[0];
		const section_one_b_100p = document.getElementsByClassName('js_section_one_b_100p')[0];
		...
		const sectionTwoContent = document.getElementsByClassName('js_section-two-content-box')[0];
		...
		if (sectionTwoA.classList.contains('section--fixed') && currentScrollPosition <= 1600) {
		...
		if (sectionTwoA.classList.contains('section--relative')) {
			leftShape.style.left = offset(section_one_b_25p).top / 1600 * 150 - 150 + '%';

			leftShapeShadow.style.left = offset(section_one_b_25p).top / 1600 * 150 - 150 + '%';

			rightShape.style.right = offset(section_one_b_25p).top / 1600 * 150 - 150 + '%';
		} else {
		...
		if (leftShape.style.left < '-60%') {
			if (document.getElementsByClassName('logo-link-wrap')[0].classList.contains('logo-link-wrap--white')) {
				document.getElementsByClassName('logo-link-wrap')[0].classList.remove('logo-link-wrap--white');
			}
		}

		const section_two_a_25p = document.getElementsByClassName('js_section_two_a_25p')[0];
		const section_two_a_50p = document.getElementsByClassName('js_section_two_a_50p')[0];
		const section_two_a_75p = document.getElementsByClassName('js_section_two_a_75p')[0];
		const section_two_a_100p = document.getElementsByClassName('js_section_two_a_100p')[0];
		...
		const phoneContainer = document.getElementsByClassName('js-phone-container')[0];
	...
	// END PHONE ANIMATION CODE...
		...
		const section_three_a = document.getElementsByClassName('js_section_three_a')[0];
...
function updateLinks(shade) {
	const currentScrollPosition = window.scrollY;
	const navDivs = document.getElementsByClassName('navbar__links')[0].getElementsByTagName('div');
	...
	switch (shade) {
		case 'light':
			...
			document.getElementsByClassName('js_signup-button')[0].classList.add('upthere_button--white');

			document.getElementsByClassName('logo-link-wrap')[0].classList.add('logo-link-wrap--white');
		...
		case 'dark':
			...
			document.getElementsByClassName('js_signup-button')[0].classList.remove('upthere_button--white');
...
function handlePhoneVisibility(el, show) {
	...
	if (show) {
		document.getElementsByClassName(el)[0].classList.add('phone-slide--visible');
	} else {
		document.getElementsByClassName(el)[0].classList.remove('phone-slide--visible');
...
function setLastAnimatedTime(time) {
	document.getElementsByClassName('js-phone-container')[0].setAttribute('data-phone-last-animated', time);
}
